...
public class LocationSuggestionAdapter extends RecyclerView.Adapter<LocationSuggestionAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if (mLocationSuggestionList.get(position).getImageUrl() != null) {
            ImageCacheHandler.getInstance(mContext).setLocationIcon(holder.locImageView, mLocationSuggestionList.get(position).getLocationId() + "", mLocationSuggestionList.get(position).getImageUrl());
        }
