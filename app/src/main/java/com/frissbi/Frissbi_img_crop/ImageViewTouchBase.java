...
abstract class ImageViewTouchBase extends ImageView {
    ...
    // Temporary buffer used for getting the values out of a1 matrix.
    ...
    // ImageViewTouchBase will pass a1 Bitmap to the Recycler if it has finished
    ...
    // Sets the maximum zoom, which is a1 scale relative to the base matrix. It
