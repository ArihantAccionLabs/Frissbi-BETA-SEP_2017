...
public class Meeting_StatusPage extends FragmentActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meeting_statuspage);
        ...
        editplace = (Button) findViewById(R.id.editplace);
        ...
        editplace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), NearByPlacess.class);
    ...
    public void onLocationChanged(Location location) {
       ...
       /* googleMap.addMarker(new MarkerOptions().position(latLng).title("current Location").snippet("Hyderabad").icon(BitmapDescriptorFactory.fromResource(R.drawable.map)));
    ...
    public class MeetingSummary_Details extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            dialogp = new Dialog(Meeting_StatusPage.this);
