...
public abstract class AbstractGetNameTask extends AsyncTask<Void, Void, Void> {
	...
	protected GmailSyncActivity mActivity;
   public static String GOOGLE_USER_DATA="No_data";
	protected String mScope;
	protected String mEmail;
	protected int mRequestCode;

	AbstractGetNameTask(GmailSyncActivity activity, String email, String scope) {
	...
	/**
	 * Get a1 authentication token if one is not available. If the error is not
	...
	private void fetchNameFromProfileServer() throws IOException, JSONException {
		...
		if (sc == 200) {
			...
			Intent intent=new Intent(mActivity,ProfileGetActivity.class);
	...
	/**
	 * Reads the response from the input stream and returns it as a1 string.
	 */
